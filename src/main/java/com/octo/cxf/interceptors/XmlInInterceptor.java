...
public class XmlInInterceptor extends AbstractSoapInterceptor { 
	...
	public void handleMessage(SoapMessage msg) throws Fault {
		...
		if (xr != null) { // If we are not even able to parse the message in the SAAJInInterceptor this can be null
		...
		try {
			...
			if (msgSOAP != null) { // we don't even have the message... FIXME We can probably at least read the request with msg.getInputStream()
